...
<html>
    <head>
        ...
        <title>F-Care | Promotion Detail</title>
        <style>
            .middle{
                position: relative;
                width: 100%;
    ...
    <body>
        ...
        <div class="middle">
            ...
            <div class="middle-content">
                <div class="f-title">Chi Tiết Khuyến Mại</div>
            </div>
        </div>
        <div class="main">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="latest-promotion">
                                        ...
                                        <c:forEach items="${list3}" var="a">
                                            <div class="col">
                                                <div class="card h-100 hover-shadow" style="background-color: #eee;">
                                                    <a href="promotionDetail?id=${a.id}" target="_blank"><img class="object-fit-cover card-img-top" style="height: 200px; width: 100%;" src="${a.image}" alt="promotion image"/></a>
                                                    <div class="card-body" >
                                                        <a href="promotionDetail?id=${a.id}"target="_blank" class="text-4f4f4f"><h5 class="card-title">${a.title}</h5></a>
                                                        <p class="card-text">${a.description}</p>
                                                    </div>
                                                    <div style="padding: 0 24px 12px;">
                                                        <a href="promotionDetail?id=${a.id}"target="_blank" class="badge badge-info " >Xem chi tiết</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </c:forEach>
                                ...
                                <div class="text-center mt-3">
                                    <a role="button" href="promotion" target="_blank" class="btn btn-primary" data-mdb-ripple-init>Xem nhiều khuyến mại hơn</a>
                                </div>
                            </div>
                        </div>
